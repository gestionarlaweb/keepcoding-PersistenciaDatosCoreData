//
//  editPowerHeroeController.swift
//  Avengers
//
...
class editPowerHeroeController: UIViewController {
    ...
    super.viewDidLoad()
        ...
        labelHeroe.text = nombreHeroe
        imageHeroe.image = avatarHeroe
    }
